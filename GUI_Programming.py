...
root.title("First GUI Programming using Python")
ttk.Button(root, text="Hello Jahid").grid()
root.mainloop()
...
Checkbutton(root, text="Go").grid(row=4,column=1, sticky=N)
Checkbutton(root, text="Rust").grid(row=5,column=1, sticky=N)
